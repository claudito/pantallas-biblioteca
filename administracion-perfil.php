...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Actualización de Perfil: Luis Claudio <i class="fa fa-user"></i></h3>
	</div>
	<div class="panel-body">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<a class="btn btn-primary btn-xs" data-toggle="modal" href='#modal-id-actualizar'><i class="glyphicon glyphicon-refresh"></i> Actualizar Perfil</a>
...
<div class="modal fade" id="modal-id-actualizar">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<label>Nombres</label>
			<input type="text" value="Luis Augusto" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Correo Electrónico</label>
			<input type="text" value="megabyte1507@gmail.com" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Código Universidad</label>
			<input type="text" value="1107000044" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Tipo</label>
			...
			<div class="form-group">
			<label>Usuario</label>
			<input type="text" name="" class="form-control" value="1107000044" readonly="">
			</div>
			...
			<input type="text" value="Claudio Ponce" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Celular o Telefóno</label>
			<input type="text" value="997 935 085" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Fecha de Registro</label>
			<input type="text" value="01/11/2016 10:00:12 am" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Estado</label>
			<select name="" id="" class="form-control" readonly="">
			...
			<div class="form-group">
			<label>Dni</label>
			<input type="text" value="46794282" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Cargo</label>
			<input type="text" value="Administrador" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Fecha de Nacimiento</label>
			<input type="text" value="15/07/1991" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Especialidad</label>
			<input type="text" value="Ing de Sistemas" class="form-control input-sm" readonly="">
			</div>
			<div class="form-group">
			<label>Turno</label>
			<select name="" id="" class="form-control" readonly>
