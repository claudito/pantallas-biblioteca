...
<div class="modal fade" id="modal-id-actualizar">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<label>Código</label>
			<input type="text" class="form-control" value="GRUGAFAIT">
			</div>
			<div class="form-group">
			<label>Descripción</label>
			<input type="text" class="form-control" value="Alfaomega Grupo Editor">
			</div>
