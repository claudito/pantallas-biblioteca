...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<tbody>
		    <tr>
				<td>2</td>
				<td>Ingenería de Sistema e Informatica</td>
			...
			<tr>
				<td>1</td>
				<td>Administración en Turismo, Hotelería y Gastronomía</td>
...
<div class="modal fade" id="modal-id-actualizar">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<input type="text" value="Ingenería de Sistema e Informatica" id="" class="form-control">
			<div class="form-group">
			<label for="">Facultad</label>
			<select name="" id="" class="form-control">
			<option value="">Ciencias e Ingeniería</option>
			</select>
			</div>
			</div>
			</div>
