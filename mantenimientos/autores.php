	...
	<div class="panel-body">
		...
		<tbody>
		    <tr>
				<td>2</td>
				<td>AÁNLTET</td>
				<td>Beltrán, Arlette</td>
				<td>Autor Corporativo</td>
				<td>
...
<div class="modal fade" id="modal-id-actualizar">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<input type="text" value="AÁNLTET" id="" class="form-control">
			</div>
			<div class="form-group">
			<label>Descripción</label>
			<input type="text" class="form-control" value="Beltrán, Arlette">
			</div>
			<div class="form-group">
			<label for="">Tipo</label>
			<select name="" id="" class="form-control">
			<option value="">[Seleccione el tipo de Autor]</option>
			</select>
			</div>
			</div>
			</div>
