...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Solicitud de Prestamo de Títulos</h3>
	</div>
	<div class="panel-body">
		...
		<tbody>
		    <tr>
				...
				<td><button class="btn btn-default">Prestado</button></td>
				
				<td>
				<a class="btn btn-warning btn-xs" data-toggle="modal" href='#modal-id-actualizar'><i class="fa fa-smile-o fa-2x"></i> Prestado </a>
			...
			<tr>
				...
				<td><button class="btn btn-default">Disponible</button></td>
				<td>
				<a class="btn btn-primary btn-xs" data-toggle="modal" href='#modal-id-actualizar'><i class="fa fa-hand-o-right fa-2x"></i> Solicitar</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Solicitar Prestamo</h4>
			</div>
